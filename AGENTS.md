...
Inactive or archival project retained for reference; avoid expanding scope without explicit direction.

## Workspace Context

- Workspace path: `apps/inactive/DatingAppExtractor/claude_code-multi-AI-MCP`
- Repository name: `claude_code-multi-AI-MCP`
- Kind: inactive/archival project
...
- Inactive project: avoid broad modernization or dependency churn unless the user explicitly asks to revive it.
